...
const ActivityItem = ({ card, addJoin }) => {
  const [joinListShow, setJoinListShow] = useState(false);
  const [dropOutShow, setDropOutShow] = useState(false);
  const {
    id,
    author,
    createTime,
      ...
      <div className={styles.card}>
        ...
        <div className={styles.btnBox}>
          <div className={styles.display}>
            ...
            <button className={` ${styles.btns} ${styles.dropBtn}`}>
              Drop Out
            </button>
            <button className={`${styles.btns} ${styles.delete}`}>
              Delete
            </button>
          </div>
